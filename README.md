...
[![GitHub stars](https://img.shields.io/github/stars/Alpha-Park/genpark-contract-net-protocol-cnp-task-clearing-skill?style=social)](https://github.com/Alpha-Park/genpark-contract-net-protocol-cnp-task-clearing-skill/stargazers)
...
```bash
git clone https://github.com/Alpha-Park/genpark-contract-net-protocol-cnp-task-clearing-skill.git
